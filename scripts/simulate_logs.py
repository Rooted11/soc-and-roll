...
def send_batch(url: str, logs: list) -> dict:
...
def main():
    parser = argparse.ArgumentParser(description="AI-SOC log simulator")
    ...
    print(f"AI-SOC Log Simulator → {args.url}")
    ...
    while True:
        ...
        try:
            result = send_batch(args.url, logs)
